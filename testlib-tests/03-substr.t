...
is(
    TestLib::Digest::fnv64a(substr($str, 3, 3)),
    hex('0x1250b4191dafc2a4'),
    "'lo ' fnv64a hash wrong",
);

is(
    TestLib::Hello::opt_string(substr($str, 3, 3)),
    "Called with \"lo \".",
    "substr passed to Option<String>",
);
is(TestLib::Hello::opt_string(undef), "Called with None.", "undef passed to Option<String>");
is(
    TestLib::Hello::opt_str(substr($str, 3, 3)),
    "Called with \"lo \".",
    "substr passed to Option<&str>",
);
...
is(TestLib::Digest::fnv64a("emoji 🤖"), hex('0x5631099f8622bde8'), "emoji :robot: fnv64a hash");
{
    use utf8;
    is(
        TestLib::Digest::fnv64a("emoji 🤖"),
        hex('0x5631099f8622bde8'),
        "emoji :robot: fnv64a hash with 'use utf-8'",
    );
}
